...
import { decideTool, permissionExtensionFactory, type RunRuntime } from "../src/agent/ew-extensions.js";
...
function capture(runtime: RunRuntime): (e: ToolCallEvent) => Promise<ToolCallEventResult> {
  ...
  permissionExtensionFactory(runtime)(pi);
  return handler;
}
const ev = (toolName: string): ToolCallEvent =>
