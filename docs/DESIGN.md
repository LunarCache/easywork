...
- **设置 section 记忆**：`settingsSection` 提升到 App 级状态并持久化到 localStorage；聊天/工作区通过 `ew:open-settings` 可带 section detail 直达指定分区，返回设置后再次进入会落回上次停留页。
- **⌘N** 全局 keydown 新建对话。
